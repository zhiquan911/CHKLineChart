...
class ChartDatasFetcher: NSObject {
    ...
    /// 接口地址
    var apiURL = "https://www.okx.com/api/v5"
...
//        }
        ...
        let url = URL(string: self.apiURL + "/market/candles?instId=\(symbol)-SWAP&bar=\(timeType)&limit=\(size)")
            ...
            if let data = data {
                ...
                DispatchQueue.main.async {
                    ...
                    do {
                        ...
                        let chartDatas = json["data"].arrayValue
