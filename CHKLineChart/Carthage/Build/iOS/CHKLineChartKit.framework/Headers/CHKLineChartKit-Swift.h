...
SWIFT_MODULE_NAMESPACE_PUSH("CHKLineChartKit")
...
/// \param item 数据对象
///
- (void)depthChartWithChart:(CHDepthChartView * _Nonnull)chart didSelectAt:(NSInteger)index item:(CHChartItem * _Nonnull)item;
/// X轴的布局高度
/// \param chart 图表
///
///
